...
PROJECT_NAME="${CF_PAGES_PROJECT_NAME:-meshled-ui}"
...
usage() {
  cat <<'EOF'
Deploy the MeshLED control panel to Cloudflare Pages.

Usage:
  ./scripts/deploy-control-panel-cloudflare.sh [options]

Options:
  --project-name <name>  Cloudflare Pages project name (default: meshled-ui)
